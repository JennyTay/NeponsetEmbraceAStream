...
dams <- dams %>% 
  filter(dams$GNIS_Name %in% c("Pine Tree Brook", "Ponkapoag Brook", "Traphole Brook") |
           dams$FID_1 %in% c(4, 18, 83, 90, 100, 89, 10, 117)) 
dams$Goal <-  c("connectivity", "headwaters", "connectivity", "mainstem", "connectivity", "connectivity", "mainstem", "streamflow", "connectivity", "headwaters", "mainstem", "headwaters", "mainstem", "streamflow", "streamflow", "mainstem")
